                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form action="{{ route('customers.destroy', $customer->id) }}" method="POST" class="d-inline">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Hapus customer ini?')">
    ...
    <div class="card mb-2 shadow-sm border-0 rounded-3">
        <div class="card-body">
            ...
            <h5 class="card-title mb-0">
                <a class="text-decoration-none d-block fw-bold text-dark" data-bs-toggle="collapse" href="#customer-{{ $customer->id }}" role="button">
            ...
            <div class="collapse mt-2" id="customer-{{ $customer->id }}">
                ...
                <div class="d-grid gap-2">
                    ...
                    <a href="{{ route('customers.edit', $customer->id) }}" class="btn btn-warning btn-md w-100">
                        <i class="fa-solid fa-pen"></i> Edit
                    </a>
                    <form action="{{ route('customers.destroy', $customer->id) }}" method="POST" class="d-grid">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="btn btn-danger btn-md w-100" onclick="return confirm('Hapus customer ini?')">
                            <i class="fa-solid fa-trash"></i> Hapus
                        </button>
                    </form>
                </div>
